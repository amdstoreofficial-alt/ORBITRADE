...
import { Link2, Copy, Users, DollarSign, TrendingUp, Check, ShieldAlert } from 'lucide-react';
      ...
      <main className="flex-grow p-4 max-w-6xl mx-auto w-full">
        {isDemoMode ? (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <p className="text-gray-500 text-sm mb-6 max-w-sm">The affiliate program is only available for real accounts. Switch to your real account to start earning.</p>
            <button onClick={() => navigate('/dashboard')}
              className="px-6 py-2.5 rounded-xl bg-electric text-white text-sm font-medium hover:shadow-lg hover:shadow-electric/20 transition-all"
